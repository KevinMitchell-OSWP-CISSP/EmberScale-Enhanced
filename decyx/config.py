...
MAX_ANALYSIS_FUNCTIONS = 50
MAX_STRING_ANALYSIS = 100
DEFAULT_ANALYSIS_DEPTH = "medium"  # low, medium, high
...
LOG_LEVEL = os.environ.get("EMBERSCALE_LOG_LEVEL", "INFO")
ENABLE_DEBUG_LOGGING = os.environ.get("EMBERSCALE_DEBUG", "false").lower() == "true"

# Usage Tracking Configuration
ENABLE_USAGE_TRACKING = True
USAGE_TRACKING_INTERVAL = 300  # seconds
